...
/**
 * 시·군 구분 — 대회를 찾을 때 검색어를 만드는 데 씁니다 ("천안시청 공고" 처럼).
 * REGIONS 와 순서가 달라져도 되도록 이름으로 적어 둡니다.
 */
const REGION_KIND = {
  천안: "시", 공주: "시", 보령: "시", 아산: "시", 서산: "시", 논산: "시", 계룡: "시", 당진: "시",
  금산: "군", 부여: "군", 서천: "군", 청양: "군", 홍성: "군", 예산: "군", 태안: "군"
};

/**
 * 대회를 찾아볼 곳 — 운영 현황의 '대회 찾기'가 이 목록으로 검색어를 만듭니다.
 * 충남 선수만 나갈 수 있는 대회는 대개 시·군청과 청소년기관이 공고합니다.
 * {지역} 자리에 시·군 이름이 들어갑니다.
 */
const EVENT_SOURCES = [
  { id: "city", name: "시·군청 공고",
    query: "{지역}{시군}청 e스포츠 대회 공고",
    wide: "충청남도 시군청 e스포츠 대회 공고" },
  { id: "youth", name: "청소년수련관",
    query: "{지역} 청소년수련관 e스포츠 대회",
    wide: "충청남도 청소년수련관 e스포츠 대회" },
  { id: "culture", name: "청소년문화의집",
    query: "{지역} 청소년문화의집 e스포츠 대회",
    wide: "충청남도 청소년문화의집 e스포츠 대회" },
  { id: "all", name: "지역 구분 없이",
    query: "충청남도 {지역} e스포츠 대회",
    wide: "충청남도 e스포츠 대회 참가 모집" }
];

/** 검색 엔진 — 새 곳을 넣고 싶으면 한 칸 추가하면 됩니다 */
const SEARCH_ENGINES = [
  { id: "naver", name: "네이버", url: "https://search.naver.com/search.naver?query=" },
  { id: "google", name: "구글", url: "https://www.google.com/search?q=" }
];
